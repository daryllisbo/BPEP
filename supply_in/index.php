...
<head>
    ...
    <link rel="stylesheet" href="supply_in_styles.css">
...
<body>
    ...
    <div class="container product-out">
        <div class="conth1">
            <h1><i class="fas fa-truck"></i> Supply In</h1>
        </div>
        <div class="scrollable-content">
            <form method="POST" action="update_inventory.php" id="supplyForm">
                ...
                <div class="form-group">
                    <label for="client-name">Supplier Name <span class="required">*</span></label>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="product-code" placeholder="Enter product code" name="product-code[]"
                        required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="model-description" id="model-description"
                        placeholder="Autofilled based on product code" readonly>
                </div>
                <div class="form-group">
    ...
    <script>
        ...
        <div class="additional-item">
            ...
            <div class="form-group">
                <label>Serial Numbers <span class="required">*</span></label>
            ...
            <div class="form-group quantity">
                <label for="quantity">Quantity <span class="required">*</span></label>
                <input type="number" class="new-quantity" name="quantity[]" placeholder="0" readonly>
            </div>
        </div>
        `;

                // Append new input fields to the additional items container
                additionalItemsContainer.insertAdjacentHTML('beforeend', newInputFields);

                // Get the newly added product code and model description inputs
                const newProductCodeInput = additionalItemsContainer.lastElementChild.querySelector('.new-product-code');
                const newModelDescriptionInput = additionalItemsContainer.lastElementChild.querySelector('.new-model-description');

                // Get the newly added item container
                const newItemContainer = additionalItemsContainer.lastElementChild;

                const newBrandInput = newItemContainer.querySelector('.new-brand');

                // Find the remove button inside the newly added item container
                const removeBtn = newItemContainer.querySelector('.remove-item');
                removeBtn.addEventListener('click', function () {
                    newItemContainer.remove(); // This removes the item
                });
                ...
                additionalItemsContainer.lastElementChild.querySelector('.new-serial-numbers').addEventListener('input', function () {
                    updateAdditionalItemQuantity(additionalItemsContainer.lastElementChild);
                });
            ...
            exportBtn.addEventListener('click', function () {
                ...
                // After saving the PDF, log the export action
                logExportActivity('Exported supply data to PDF.');

                // Function to log export actions
                function logExportActivity(description) {
                    fetch('log_export_activity.php', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/x-www-form-urlencoded',
                        },
                        body: `action=exported_to_pdf&description=${encodeURIComponent(description)}`
                    })
        ...
        // Get the form element for Supply In
        ...
        supplyForm.addEventListener('submit', function (event) {
            ...
            // Create a new FormData object to collect all form data
            const formData = new FormData(supplyForm);

            // Select all additional items
            const additionalItemContainers = document.querySelectorAll('.additional-item');
            ...
            // Submit the form data via fetch as before
